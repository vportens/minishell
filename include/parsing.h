...
/*   Updated: 2021/11/21 21:04:57 by viporten         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		unclost_quote(char	*str);
t_quote	updatt_quote_status(char c, t_quote quote);
t_quote	updatt_quote_succes(t_token *stc, int *i, t_quote quote, char **s1);
